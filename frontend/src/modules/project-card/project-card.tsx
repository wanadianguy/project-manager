...
export const ProjectCard = (props: ProjectCardProps) => {
    ...
    const progress = budget.forecast > 0 ? (budget.actual / budget.forecast) * 100 : 0;
    ...
    return (
        <Card sx={{ mb: 2 }}>
            <CardContent>
                ...
                >
                    <Box sx={{ flex: 1 }}>
                        ...
                        <Chip label={props.project.status} size="small" sx={{ mr: 1 }} />
                ...
                <Box sx={{ mt: 2 }}>
                    ...
                    >
                        <Typography variant="caption">
                            ${budget.actual.toFixed(0)} / ${budget.forecast.toFixed(0)}
                        </Typography>
                        <Typography variant="caption" color={budget.remaining < 0 ? 'error' : 'success.main'}>
            ...
            <CardActions>
                <Button size="small" onClick={() => props.onOpen(props.project)}>
                    Open Project
                </Button>
            </CardActions>
        </Card>
